...
import ListMenu from "../../pertemuan5/layouts/ListMenu";
    ...
    return (
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div id="sidebar-logo" className="flex flex-col">
                ...
                <span id="logo-subtitle" className="font-barlow text-gray-400">Modern Admin Dashboard</span>
            </div>
            ...
            <div id="sidebar-footer" className="mt-auto">
                <div id="footer-card"className="bg-hijau px-4 py-2 rounded-md shadow-lg mb-10 flex items-center">
                    <div id="footer-text"className="text-white text-sm">
                        ...
                        <div id="add-menu-button"className="flex justify-center 
                        items-center p-2 mt-3 bg-white rounded-md space-x-2">
